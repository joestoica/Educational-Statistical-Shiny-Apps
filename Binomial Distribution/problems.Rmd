...
## 1 Nancy has a coin that has a 75% of showing heads when it is flipped. What is the chance she is going to flip the coin 5 times? Assume each toss is independent.
...
## 3 A car salesman has 20 cars in his lot. He feels that there is a 40% chance of selling any one car during the week. Compute the probability of selling less than 5 cars in one week. Assume each sale is independent.
...
## 4 A star basketball player shoots 20 shots during his game. His shooting accuracy  is 85%. Find the probability that he makes more than 15 of his shots in one  game. Assume each shot is independent.
